...
if __name__ == '__main__':
    ...
    generate_stimulus_videos(input_image_path, '/media/data_cifs/rapid_categorization/clicktionary_masked_images_balanced_cut_50', onset_times_ms, after_time_ms, stim_show_time_ms=50)
